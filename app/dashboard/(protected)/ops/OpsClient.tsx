...
import {
  ...
  Play, Plug, RefreshCw, Wrench, Briefcase, ListChecks,
} from "lucide-react"
...
import { AnalyticsPeriodProvider } from "@/components/analytics"
import {
  HcPill, RunDots, StatusLegend, relativeTime, fmtDuration, findCheck, hcStyle, JOB_HC_SLUGS,
...
function OpsClientInner() {
  ...
  return (
    <motion.div variants={dashboardPage} initial="hidden" animate="visible" className="flex flex-col gap-6 max-w-6xl">
      ...
      <OverviewSection />
      <Link href="/dashboard/ops/analytics" className="self-start text-xs text-primary hover:underline">
        View full analytics →
      </Link>
