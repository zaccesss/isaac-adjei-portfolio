...
function CopyButton({ value }: { value: string }) {
  ...
  return (
    <button type="button" onClick={copy} aria-label="Copy" title="Copy" className="p-1.5 rounded hover:bg-muted transition-colors text-muted-foreground hover:text-foreground">
...
function SecretField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button type="button" onClick={() => setShow((s) => !s)} aria-label={show ? "Hide" : "Show"} title={show ? "Hide" : "Show"} className="p-1.5 rounded hover:bg-muted transition-colors text-muted-foreground hover:text-foreground">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button type="button" aria-label="Entry options" title="Entry options" onClick={(e) => e.stopPropagation()} className="p-1 rounded hover:bg-muted text-muted-foreground hover:text-foreground transition-colors">
