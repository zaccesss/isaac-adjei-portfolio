...
function statusTextClass(status: string): string {
  ...
  if (s === "Interested")             return "text-sky-500 dark:text-sky-400"
  ...
  if (s === "Case Study")             return "text-purple-600 dark:text-purple-400"
  ...
  if (s === "Video Interview")        return "text-yellow-600 dark:text-yellow-400"
  if (s === "Face-to-face Interview") return "text-orange-500 dark:text-orange-400"
  if (s === "Assessment Centre")      return "text-orange-700 dark:text-orange-500"
