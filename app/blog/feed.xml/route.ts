    ...
    <div class="container">
      <div class="header">
        ...
        <div class="subscribe-box">
          ...
          <span>This is an RSS feed. Subscribe in your reader at <a href="${baseUrl}/blog/feed.xml">isaacadjei.me/blog/feed.xml</a> or browse <a href="${baseUrl}/blog">blog</a>.</span>
        </div>
        <br/>
        <a class="raw-btn" href="${baseUrl}/blog/feed.xml?raw">&#60;/&#62; View raw XML</a>
      </div>
...
export function GET(request: Request) {
  ...
  // I serve raw XML for ?raw so Chrome renders its native tree viewer (collapsible
  // nodes, syntax colouring): identical to how simonwillison.net/atom/ looks.
  if (forceRaw) {
