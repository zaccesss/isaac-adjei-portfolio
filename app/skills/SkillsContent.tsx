...
function SkillCard({ skill }: { skill: Skill }) {
  return (
    <div className="group flex flex-col items-center gap-2 p-3 w-[70px] sm:w-[88px] rounded-xl border bg-card hover:border-primary/50 hover:shadow-lg hover:-translate-y-1.5 hover:scale-105 transition-all duration-200 cursor-default">
      {skill.icon ? (
