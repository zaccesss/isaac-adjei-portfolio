...
// Weekly iCal routine feed.
// Generates concrete VEVENTs for the current Mon-Sun in Europe/London timezone.
// Switches to the next week at Monday 00:00 Europe/London - no RRULE.
// Apple Calendar subscription refreshes hourly so the new week loads automatically.
