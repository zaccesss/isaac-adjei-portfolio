...
- Blog posts and project pages now name their section in the browser tab too, matching how TIL already did it: Blog | the post title, Project | the project name, TIL | the entry title (TIL's own separator moved from a colon to match)
