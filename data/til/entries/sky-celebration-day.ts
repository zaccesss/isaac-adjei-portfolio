...
const _sky_celebration_day: TILEntry = {
    id: "sky-celebration-day",
    title: "A room full of people who look like you changes what you believe is possible",
    date: "2026-06-24",
    category: "Life",
    published: true,
    ...
    detail: [
      ...
      {
        type: "p",
        text: "Sky's engineering teams work on broadcast infrastructure, streaming at scale, set-top box firmware, mobile apps and internal tooling. The intersection with my own interests (embedded firmware, full-stack web, systems) was closer than I expected. The Early Careers programme includes technology placements and graduate schemes with structured rotations.",
      },
      {
        type: "note",
        text: "Grateful to God for every open door. Grateful to everyone who has poured into this journey. Days like this are fuel.",
      },
    ],
