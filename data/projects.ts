...
export const projects: Project[] = [
  ...
  },
  {
    id: "git-unlocked",
    title: "git-unlocked",
    description: "Free, open source course taking anyone from zero to industry-level Git proficiency across every major platform - still being built",
    longDescription:
      "git-unlocked is a free, MIT-licensed, community-built course designed to take anyone from never having heard of version control all the way to using Git, GitHub, GitLab and every major platform confidently in real teams. It is structured across three learning paths - beginner, intermediate and advanced - and covers 8 platforms: Git itself, GitHub, GitLab, Bitbucket, Azure DevOps, Gitea, Forgejo and Codeberg.\n\nThe course currently has 138 topic files across 8 platform sections. Every file covers Windows, Mac and Linux side by side, includes real worked examples, step-by-step exercises and a dedicated section on common mistakes. Topics range from core Git internals and branching strategy through to advanced subjects including rebase, bisect, worktrees, signing commits, monorepos, GitOps and the full reference of all Git commands. The platform sections cover everything from account setup and repositories through to CI/CD pipelines, branch protection, security features, CLI tools and cross-platform comparisons.\n\nThe repo includes GitHub Actions workflows for automated markdown linting and link checking on every push, a Hall of Fame for contributors, a Code of Conduct, issue templates for bug reports and content suggestions, and a PR template. Several sections (real-world scenarios, IDE integrations, terminal setup, reference cards and first-contribution guides) are planned and on the public roadmap. The course is actively being built and open to contributions.",
    technologies: ["Git", "GitHub", "GitLab", "Markdown", "GitHub Actions", "Open Source"],
    category: "other",
    featured: true,
    images: [],
    ...
    date: "2026",
    highlights: [
      "138 topic files across Git, GitHub, GitLab, Bitbucket, Azure DevOps, Gitea, Forgejo and Codeberg",
      "Three learning paths: beginner, intermediate and advanced - structured end to end",
      "Every command and workflow shown on Windows, Mac and Linux side by side",
      "Advanced Git topics: rebase, bisect, worktrees, monorepos, GitOps, signed commits",
      "GitHub Actions CI for markdown linting and link checking on every push",
      "Open source with Hall of Fame, Code of Conduct, issue templates and PR template",
    ],
  },
]
