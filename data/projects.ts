...
export const projects: Project[] = [
  ...
  },
  {
    ...
    date: "2026",
    highlights: [
      "FastAPI backend processes every telemetry POST in under 200ms: validate, store, evaluate alert rules, score ML, respond",
      "Isolation Forest ML: unsupervised anomaly detection — score >0.7 triggers alert, >0.85 attaches diagnostic recommendation",
      "STM32 samples MPU6050 at 100Hz and computes FFT per second, outputting peak vibration frequency to the ML model",
      "Next.js live dashboard: Recharts line charts polling every 5s, anomalous readings highlighted red in real time",
      "JWT auth + role-based access control (Admin, Technician, Viewer) enforced at both API and UI level with full audit log",
      "Full Docker Compose stack — Vercel (frontend), Render (backend + database), operational in under an hour",
    ],
  },
]
