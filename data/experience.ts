...
export const experiences: Experience[] = [
  {
    ...
    achievements: [
      "Represent student views and concerns to academic staff and university management",
      "Facilitate communication between the student body and the department to improve the course experience",
      "Active member of the Aston Computing and Electronics Society, standing for President and Treasurer positions",
    ],
  },
  {
    id: "mcdonalds",
