#!/usr/bin/env python3
# I push my Lenovo laptop's battery level and charging state to Upstash Redis every 30 seconds so my portfolio dashboard can display the device widget in real time.
"""
